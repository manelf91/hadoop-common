 ...
 */
public class CreateIndexesHadoopPlusPlus extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		JobConf conf = new JobConf(getConf(), CreateIndexesHadoopPlusPlus.class);
	...
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new Configuration(), new CreateIndexesHadoopPlusPlus(), args);
		System.exit(res);
	}
