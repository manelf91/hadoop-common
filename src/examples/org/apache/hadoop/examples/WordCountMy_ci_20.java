 ...
 */
public class WordCountMy_ci_20 extends Configured implements Tool {
  ...
  public int run(String[] args) throws Exception {
    JobConf conf = new JobConf(getConf(), WordCountMy_ci_20.class);
    conf.setJobName("wordcountmy_ci_20");
    ...
    conf.setIfUnset("blocks.per.split", "20");
  ...
  public static void main(String[] args) throws Exception {
    int res = ToolRunner.run(new Configuration(), new WordCountMy_ci_20(), args);
    System.exit(res);
  }
