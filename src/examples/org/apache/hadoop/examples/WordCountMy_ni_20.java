 ...
 */
public class WordCountMy_ni_20 extends Configured implements Tool {
  ...
  public int run(String[] args) throws Exception {
    JobConf conf = new JobConf(getConf(), WordCountMy_ni_20.class);
    conf.setJobName("wordcountmy_ni_20");
  ...
  public static void main(String[] args) throws Exception {
    int res = ToolRunner.run(new Configuration(), new WordCountMy_ni_20(), args);
    System.exit(res);
  }
